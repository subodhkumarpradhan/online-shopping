...
import net.skp.shoppingbackend.dao.ProductDAO;
...
/*	@Test
	public void testCRUDProduct(){
		...
		assertEquals("Something went wrong while updating the exiting record!", true, productDAO.update(product));
		
		assertEquals("Something went wrong while deleting the exiting record!", true, productDAO.delete(product));
